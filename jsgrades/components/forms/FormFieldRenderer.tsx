...
export const FormFieldRenderer: React.FC<FormFieldRendererProps> = ({
    ...
    switch (field.type) {
                                    ...
                                    ? [
                                          {
                                              ...
                                              label: field.validation.min.toString(),
                                          },
                                          {
                                              value: field.validation.max,
                                              label: field.validation.max.toString(),
                                          },
                                      ]
                                    : undefined
                            }
        ...
        case 'checkbox':
            return (
                <div className='w-full rounded-lg border border-gray-200 bg-white p-4 transition-colors duration-200 hover:border-gray-300'>
                    <FormControlLabel
                        control={
                            <Checkbox
